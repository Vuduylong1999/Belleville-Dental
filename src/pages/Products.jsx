        ...
        <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <img src={banner1} className="d-block w-100 carousel-img" alt="..." />
                </div>
                <div className="carousel-item">
                    <img src={banner2} className="d-block w-100 carousel-img" alt="..." />
                </div>
                <div className="carousel-item">
        ...
        <div className="container" >
            ...
            <div className="bg-sale text-white  mt-4" >
                ...
                <div className="d-flex align-items-center gap-3 " >
                    ...
                    <img className="mb-4 icon-flash-sale" src={ngonLua} alt="" />
                </div>
