...
export default function BlogSidebar({ categories, relatedPosts, tags, searchQuery, onSearchChange }) {
    return (
        <aside className="blog-sidebar">
            ...
            <div className="aside-related-posts mb-4">
                <h4 className="mb-3">Related Posts</h4>                <div className="list-group">                    {relatedPosts.map((post) => (
                        <Link 
                            key={post.id} 
                            to={`/education/${window.location.pathname.split('/')[2]}/${post.id}`}
